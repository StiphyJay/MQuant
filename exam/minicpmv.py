...
max_token = {"docVQA": 100, "textVQA": 100, "docVQATest": 100}
...
class MiniCPM_V:
    ...
    def generate(self, images, questions, datasetname):
        ...
        default_kwargs = dict(
            max_new_tokens=max_new_tokens, sampling=False, num_beams=3
        )
        res = self.model.chat(
            image=image,
            msgs=msgs,
    ...
    def generate_with_interleaved_calib(self, images, questions, datasetname):
        prompt = "Answer the question directly with single word."

        default_kwargs = dict(max_new_tokens=1, sampling=False, num_beams=3)
